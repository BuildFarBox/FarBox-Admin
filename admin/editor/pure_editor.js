...
(function() {
  var EditorModel, Post, controls_width, make_textarea_center, posts_host, realtime_input, sync_gateway,
    _this = this;
  ...
  realtime_input = function(editor_model) {
    var connect_to_farbox, keep_live, socket, ws_protocl, ws_url,
      _this = this;
    ...
    if ((typeof WebSocket !== "undefined" && WebSocket !== null) && (typeof JSON !== "undefined" && JSON !== null)) {
      ...
      connect_to_farbox = function() {
        ...
        socket.onmessage = function(message) {
          ...
          if (note.path === editor_model.current_post().path) {
            return $.get('/admin/editor/appended/~' + note.path, {}, function(data) {
              var text_dom;

              if (data) {
                text_dom = $('#textarea');
                return text_dom.val(text_dom.val() + '\n\n' + data);
              }
            });
          }
        };
      ...
      connect_to_farbox();
      return setInterval(keep_live, 30000);
    }
  };
  ...
  this.run_editor = function() {
    ...
    return $(document).ready(function() {
      ...
      return realtime_input(editor_model);
    });
  };
